...
public class CreateOrderActivity extends AppCompatActivity {
    ...
    public void onClickSendOrder(View view) {
        ...
        String optionOfOrder = "";
        if (drink.equals(getString(R.string.tea))) {
            optionOfOrder = spinnerTea.getSelectedItem().toString();
        } else if(drink.equals(getString(R.string.coffee))) {
            optionOfOrder = spinnerCoffee.getSelectedItem().toString();
        String order = String.format(getString(R.string.order), name, password, this.drink, optionOfOrder);
        String additions;
